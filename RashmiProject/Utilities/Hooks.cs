    ...
    public class Hooks
    {
        ...
        private string TakeScreenshot()
        {
            try
            {
                ...
                string filePath = Path.Combine(screenshotsFolderPath, $"Screenshot_{DateTime.Now:yyyyMMdd_HHmmss}.png");
                Directory.CreateDirectory(screenshotsFolderPath);  // Ensure the folder exists
                screenshot.SaveAsFile(filePath, ScreenshotImageFormat.Png); // Save the screenshot as a file
        ...
        private void TakeScreenshot1()
        {
            ...
            {
                Console.WriteLine("Error while ensuring screenshots folder: " + ex.Message);
            }
        }
    }
}
